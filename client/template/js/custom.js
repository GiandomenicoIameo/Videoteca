...
$(function(){
	...
	var noleggiaLink = $(".noleggiaLink");
	var restituisciLink = $( ".restituisciLink" );
	...
	// Se viene premuto il tasto restituisci, apparirà
	// la schermata di Log in.

	restituisciLink.on('click', function(event){
    	event.preventDefault();
    	loginct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
	...
	// Se viene premuto il tasto noleggia, apparirà
	// la schermata di Log in.

	 noleggiaLink.on('click', function(event){
    	event.preventDefault();
    	loginct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
